...
def robots_txt():
    """Allow search engines to crawl the public FRIS site and advertise the sitemap."""
    body = (
        "User-agent: *\n"
        "Allow: /\n"
        "\n"
        "Sitemap: https://frisearthintelligence.tech/sitemap.xml\n"
    )
...
def sitemap_xml():
    """Minimal XML sitemap for the public FRIS landing page."""
    xml = """<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://frisearthintelligence.tech/</loc>
  </url>
</urlset>
"""
