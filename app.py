...
<html>
<head>
    <title>FRIS Carbon Pool Movement</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <style>
        * {{ box-sizing: border-box; font-family: Arial, sans-serif; }}
        body {{ margin: 0; background: #061307; color: white; padding: 24px; }}
...
<body>
    <a class="btn" href="/">← Back to Dashboard</a>
    <div class="box">
        <h1>🌿 FRIS Carbon Pool Movement</h1>
        <div class="note">
            This is Forest Department planning support. It shows existing carbon pool and grid-level carbon movement against the locked FRIS baseline. It is not certified carbon-credit issuance.
        </div>
        <div class="cards">
            ...
            <div class="card">Stable Grids<b>{counts['stable']}</b></div>
            <div class="card">Gain / Loss Grids<b>{counts['gain']} / {counts['loss']}</b></div>
        </div>
    </div>
</body>
</html>
