...
# FILE PATHS
# ============================================================
# Render/Linux cannot read Windows path C:\cfris\output.
# So the deployed app reads latest FRIS files from the same folder
# where app.py is placed.
#
# Required files in GitHub/Render root:
# - app.py
# - fris_latest.csv
...
def load_fris_data():
    if not LATEST_CSV.exists():
        return pd.DataFrame(), {
            "csv_found": False,
            "message": f"No FRIS CSV found. Upload fris_latest.csv in the same folder as app.py. Expected path: {LATEST_CSV}"
        }
