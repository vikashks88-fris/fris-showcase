...
# - Reads fris_latest.csv from same folder as app.py
# - Reads fris_latest_map.html from same folder as app.py
# - Does NOT use Windows C:\ paths
# - Does NOT require zoneinfo
# - Shows India time using UTC+05:30
# ============================================================
...
LATEST_CSV = BASE_DIR / "fris_latest.csv"
LATEST_MAP = BASE_DIR / "fris_latest_map.html"
...
def load_fris_data():
    if not LATEST_CSV.exists():
        return pd.DataFrame(), {
            "csv_found": False,
            "message": "No FRIS CSV found. Upload fris_latest.csv in the same GitHub/Render folder as app.py.",
...
def dashboard():
    ...
    for i, (_, r) in enumerate(df.head(20).iterrows(), start=1):
        rows.append({
            ...
            "soil_type": safe_text(r.get("soil_type")),
...
<div class="box">
    ...
    <p>Put this file in the same GitHub/Render folder as <code>app.py</code>.</p>
</div>
</body>
</html>
"""
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .panel { padding: 16px; }
        .panel h3 { margin: 0 0 14px; font-size: 17px; letter-spacing: 0.5px; }
        ...
        tr:hover { background: rgba(134, 239, 69, 0.06); }
    ...
    <main class="main">
                ...
                {% else %}
                    <div class="fake-map">
                        <div>
                            ...
                            <p>Expected: fris_latest_map.html in the same folder as app.py</p>
                        </div>
                    </div>
                {% endif %}
            </section>
            ...
            <section>
                <div class="cards">
                    ...
                    <div class="panel">
                        ...
                        <div class="stat-row"><span>Status</span><span class="yellow">{{ summary.imd_status }}</span></div>
        ...
        <div class="summary-strip">
            ...
            <div class="panel">
                ...
                <div style="color:var(--muted);">History days: {{ summary.history_days }} / 365</div>
            </div>

            <div class="panel">
                <h3>🌱 Soil Context</h3>
                <div class="big-number">{{ summary.soil_retention }}</div>
                <div style="color:var(--muted);">{{ summary.soil_type }}</div>
            </div>
        </div>
        ...
        <div class="panel wide">
            ...
            <p style="color:#d9f99d; line-height:1.55; margin:14px 0 0;">
                FRIS uses soil behavior to interpret moisture more intelligently. Sandy-loam areas may dry faster,
                while clay-loam areas retain moisture longer. This improves patrol priority and ecological interpretation.
            </p>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="green">{{ r.weather_fire }}</td>
        ...
        <div class="footer">
            ...
            <span>Sources: Google Earth Engine, NASA FIRMS, Open-Meteo, ERA5, IMD-ready, SoilGrids/NBSS&LUP-ready</span>
        </div>
    </main>
</div>
</body>
