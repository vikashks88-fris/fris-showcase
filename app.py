...
def build_saved_map_overlay():
    ...
    ">
        ...
        <div style="margin-bottom:7px;">
            This is the <b>Operational Attention Layer</b>.
        ...
        <div style="
            ...
            font-weight:700;
        ">
            Yellow/orange grids are not confirmed burning.
        </div>
    </div>
    """
...
def inject_overlay_into_saved_map(map_html):
    ...
    if "</body>" in map_html:
        return map_html.replace("</body>", overlay_html + "\n</body>", 1)

    return map_html + overlay_html
