...
def view_full_map():
    """Stream the saved FRIS HTML map file.

    The main dashboard displays this route inside an iframe, so the map seen on
    the dashboard is the same file available through Download Map / Open Full Map.
    No extra dashboard Leaflet colouring or GeoJSON rebuild is applied.
    """
