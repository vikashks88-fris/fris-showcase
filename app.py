...
def make_csv_grid_geojson(df):
    ...
    return {"type": "FeatureCollection", "features": features, "source": "CSV light patrol-priority grid builder", "feature_limit": MAX_MAP_FEATURES, "selection_rule": "top patrol_priority_rank grids"}
