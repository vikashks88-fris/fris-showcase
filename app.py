...
def make_ecology_inference(row):
    """Human-readable ecological inference layer extracted from app11c.py watch-list thinking."""
    watch = classify_ecological_watch(row)
...
def ecological_summary_text(df):
    ...
    return "Most Godda forest grids remain stable in the current run. No major active fire emergency or ecological anomaly is detected."
...
<div class="layout">
    ...
    <div class="main">
        ...
        <div class="table-card" id="ecology-inference-section">
            <h2>🌳 Ecology Inference — app11c Logic Added</h2>
            <div class="watch-note">
...
<script>
    ...
    function popupHtml(props) {{
        ...
        var ecoInf = props.ecology_inference || "No separate ecology inference available.";
        var ecoRec = props.ecology_recommendation || "Routine monitoring.";
