...
<div class="layout">
    ...
    <div class="sidebar">
        ...
        <div class="side-card">
            ...
            Old Folium Map:
            <span class="{'ok' if map_found else 'bad'}">{'Found' if map_found else 'Not Required'}</span><br><br>
    ...
    <div class="main">
        ...
        <div class="footer">
            Map is now drawn directly from GeoJSON. No iframe. No Folium HTML dependency.
        </div>
...
<script>
    ...
    function gridColor(props) {{
        ...
        if (p.includes("CRITICAL")) return "#ff1e1e";
    ...
    function popupHtml(props) {{
        ...
        var ndvi = props.ndvi !== undefined ? Number(props.ndvi).toFixed(3) : "N/A";
        var ndmi = props.ndmi !== undefined ? Number(props.ndmi).toFixed(3) : "N/A";
    ...
    fetch("/geojson")
        ...
        .then(function(data) {{
            ...
            var layer = L.geoJSON(data, {{
                style: function(feature) {{
                    ...
                    return {{
                        color: gridColor(props),
                        weight: 1,
                        fillColor: gridColor(props),
                        fillOpacity: 0.35
                    }};
                }},
        ...
        .catch(function(error) {{
            ...
            alert("GeoJSON could not load. Check /geojson and data/fris_latest.geojson");
        }});
</script>
